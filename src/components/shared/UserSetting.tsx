    ...
    <div className="h-full overflow-y-scroll relative w-4/5 bg-black-1000  rounded-[1.375rem] ">
      <div className="absolute py-10 px-[3.125rem] flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-3 w-3/4">
          <span className="text-base font-bold text-white">معلومات شخصية</span>
          <div className="flex justify-between">
            ...
            <div className="w-fit  px-7 py-3 rounded-2xl border border-black-700">
              <span className="text-base font-bold text-white">نشاط عالي</span>
            </div>
          </div>
        </div>
          ...
          <div className="flex gap-6">
            <div className="flex flex-col w-full gap-2">
              ...
              <div className="overflow-y-auto h-[7.5rem] py-3 px-5 bg-black-950 rounded-2xl">
                <span className="text-base font-normal text-black-300">لا</span>
              </div>
            </div>
            <div className="flex flex-col w-full gap-2">
              <span className="text-base font-normal text-black-300">
              ...
              <div className="overflow-y-auto h-[7.5rem] py-3 px-5 bg-black-950 rounded-2xl ">
                <span className="text-base font-normal text-black-300">
                  أعاني حاليًا من إصابة شديدة في الركبة نتيجة لحادث رياضي. خلال
                  ممارستي للتمارين القوية، قمت بحركة غير صحيحة مما تسبب في تمزق
                  في الأربطة وإلتواء في الغضروف. هذا الحادث تسبب في انقطاع العمل
                  الرياضي وتقييد حركتي بشكل كبير، وأصبحت بحاجة لعلاج شامل وفترة
                  استراحة طويلة لتعافي الركبة واستعادة القوة والحركة الطبيعية.
                </span>
              </div>
            </div>
          </div>
